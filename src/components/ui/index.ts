...
export { default as Stat, StatLabel, StatNumber, StatHelpText, StatArrow } from './Stat';
...
export type { StatArrowType, StatProps, StatLabelProps, StatNumberProps, StatHelpTextProps, StatArrowProps } from './Stat';
